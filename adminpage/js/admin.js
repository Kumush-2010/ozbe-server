...
document.getElementById("searchInput")?.addEventListener("input", function () {
  ...
  rows.forEach((row) => {
    const name =
      row.querySelector(".author-name")?.textContent.toLowerCase() || "";
    const email =
      row.querySelector(".author-email")?.textContent.toLowerCase() || "";
      ...
      tr.innerHTML = `
        <td>
          <div class="author-info">
            <img src="${
              admin.image || "https://via.placeholder.com/40"
